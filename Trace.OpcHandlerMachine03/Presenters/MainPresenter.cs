...
namespace Trace.OpcHandlerMachine03.Presenters
{
    public class MainPresenter
    {
        ...
        private void Initailization(object sender, EventArgs e)
        {
            ...
            {
            new OPCVar("RequestVerify", "ST3_1ReqChkCodeVerify", OPCVarType.BOOL),
            new OPCVar("MachineStatus","ST3_1StatusMc", OPCVarType.SINT),
            new OPCVar("RequestLogging", "ST3_1ReqLogging", OPCVarType.BOOL),
            new OPCVar("ClockSystem", "ClockSystem", OPCVarType.BOOL),
            new OPCVar("TraceabilityRdy", "TraceabilityRdy", OPCVarType.BOOL),
            new OPCVar("LoggingApp", "ST3_1LoggingApp", OPCVarType.SINT),
            ...
            new OPCVar("LoggingAppWrite","ST3_1LoggingApp", OPCVarType.SINT),
            new OPCVar("CodeVerifyResultWrite","ST3_1CodeVerifyResult", OPCVarType.SINT),
