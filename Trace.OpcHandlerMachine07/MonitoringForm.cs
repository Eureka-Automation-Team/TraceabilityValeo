...
using Trace.OpcHandlerMachine07.Presenters;
    ...
    public partial class MonitoringForm : Form, IMonitoringView
    {
        ...
        public MachineModel machine
        {
            ...
            set
            {
                ...
                if (_machine != null)
                {
                    ...
                    {
                        butRequestCodeActuater.Text = _machine.ActuatorResultDesc;
                    }
                    else
                    {
                        butRequestCodeActuater.Text = string.Empty;
                    }
                    SetButtonStatusColor(butRequestCodeActuater, Convert.ToInt32(_machine.RequestCodeActuater));
        ...
        public void group_DataChanged(object subscriptionHandle, object requestHandle, ItemValueResult[] values)
        {
            for (int i = 0; i < values.Length; i++)
            {
                ...
                {
                    int receivedData = (Int16)values[i].Value;
                    butRequestCodeActuater.Invoke(new EventHandler(
                        delegate
                        {
                            bool val = Convert.ToBoolean(receivedData);
                            var mac = this.machine;
                            ...
                            this.machine = mac;
                            _machine.RequestCodeActuater = val;
        ...
        private void butRequestCodeActuater_Click(object sender, EventArgs e)
        {
            this.machine.RequestCodeActuater = true;
            VerityActuater(this.machine, null);
        }
