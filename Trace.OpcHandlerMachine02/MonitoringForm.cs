...
using Trace.OpcHandlerMachine02.Presenters;
...
namespace Trace.OpcHandlerMachine02
{
    public partial class MonitoringForm : Form, IMonitoringView
    {
        ...
        public MachineModel machine
        {
            ...
            set
            {
                ...
                if (_machine != null)
                {
                    ...
                    this.Tag = _machine;
                    this.Text = "Station 2 : " + _machine.ManchineName;
        ...
        public void CheckNotifications()
        {
            ...
            // --------------------------------------------
            if (OPC.GetNotificationReceived("ST2LoggingApp"))
            {
                var mac = this.machine;
                mac.CompletedLogging = OPC.GetNotifiedSINT("ST2LoggingApp");
                this.machine = mac;
            }
        }
