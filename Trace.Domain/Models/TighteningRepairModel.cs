...
{
    public class TighteningRepairModel : DomainObject
    {
        public string No { get; set; }
        public decimal Min { get; set; }
        public string MinDesc
        {
            get { return Min.ToString("#0.00") + "Nm"; }
        }
        public decimal Max { get; set; }
        public string MaxDesc
        {
            get { return Max.ToString("#0.00") + "Nm"; }
        }
        public decimal Target { get; set; }
        public string TargetDesc
        {
            get { return Target.ToString("#0.00") + "Nm"; }
        }
        public decimal Result { get; set; }
        public string ResultDesc
        {
            get { return Result.ToString("#0.00") + "Nm"; }
        }
